...
def init_9Gans(mode:str, ratio:float, down:int, up:int):
    ...
    for v_id, val in enumerate(vals):
        dataroot = '/root/limanyi/DeepfakeDetection_reimplement/CNNDetection/dataset/test'
...
def init_ProGan(mode:str, data_type:str, ratio:float, down:int, up:int):
    ...
    dataroot = '/root/limanyi/DeepfakeDetection_reimplement/CNNDetection/dataset/{}/NoCmp'.format(data_type)
